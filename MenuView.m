...
-(void)show{
    ...
    UIGestureRecognizer *panGestureRecognizer2 = [[UIPanGestureRecognizer alloc]
                                                  initWithTarget:self
                                                  action:@selector(handleftPan:)];
    
    [self.leftMenuView addGestureRecognizer:panGestureRecognizer2];
    ...
    self.leftMenuView.userInteractionEnabled = YES;
...
- (void)handLeftPan2:(UIPanGestureRecognizer*)recognizer{
    NSLog(@"==================2");
}
